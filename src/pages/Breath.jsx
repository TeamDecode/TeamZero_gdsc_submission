...
const Breath = () => {
    return (
        <main className="px-3 py-4 w-full lg:w-3/4 xl:w-2/3 mx-auto">
            <div className="text-3xl font-cursive font-bold text-bl text-center mt-5">What do you want to reduce?</div>
            <div className='grid grid-cols-3 gap-4 justify-center content-center place-content-center mt-10 select-none'>
